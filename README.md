...
5. \* Шпаргалка со всеми командами
...
Первичное "рукопожатие" проводится всего один раз. Цель - добавить запись в файл `~/.ssh/known_hosts`. Выполнив команду, мы занесем в файл запись о том, что наш компьютер "доверяет" серверу GitHub.
