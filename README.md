...
Если с файлом `id_ed25519.pub` или `known_hosts` на нашем компьютере случится что-то плохое - просто повторяем этапы создания ключа или первичного "рукопожатия".