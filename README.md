...
<p style="text-align: center;">Гайд по установке и настройке `git` окружения для работы, список команд для работы, а также правила работы с этим репозиторием и его ветками.</p>
